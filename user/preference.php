...
$urlparams = $_GET;
$PAGE->set_url('/local/jra/user/preference.php', $urlparams);
...
//set up breadcrumb
$PAGE->navbar->add(jra_get_string(['user', 'preferences']), new moodle_url('preference.php'));
//end of breadcrumb
...
//content code starts here
jra_ui_page_title(jra_get_string(['user', 'preferences']));
