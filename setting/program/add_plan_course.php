...
$urlparams = $_GET;
$PAGE->set_url('/local/sis/setting/program/add_plan_course.php', $urlparams);
...
//display the form
$form = sis_setting_program_add_course_form($id);
...
$right = $right . '';	
$right = $right . '</div>';	
$right = sis_ui_box($right, get_string('added_course_list', 'local_sis'), false, true);
$str = '';
...
echo '<script>';
echo "show_plan_course('$id', 'minimal')";
echo '</script>';