...
sis_ui_page_title(get_string('campus','local_sis'));
...
echo '<div class="pull-right rc-attendance-teacher-print">' . html_writer::link($add_url, sis_ui_icon('plus-circle', '1', true) . ' ' . get_string('add_campus', 'local_sis'), array('title' => get_string('add_campus', 'local_sis'))) . '</div>';
...
$options = array(
	...
	'view_page' => 'view_campus.php',
	'edit_page' => 'add_campus.php',
...
//output the table
echo sis_ui_dump_table('si_campus', $options, $fields, 'local_sis');
