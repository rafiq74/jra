...
$urlparams = $_GET;
$PAGE->set_url('/local/sis/admin/setting/replication.php', $urlparams);
...
sis_ui_show_flash_message('replicate_institute_data');
...
$output = '<form name="form1" action="replicate_institute_data.php">';
$output .= '<div class="pt-3">';
$institute_list = sis_lookup_institute();
//one button
$output .= 'Select Institute : ' . sis_ui_select('institute', $institute_list, '');
//end of one button
$output .= '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
//one button
...
$output .= '<p>&nbsp;</p>';
//one button
$output .= '<button type="submit" class="btn btn-primary" value="Copy">Copy Data to Target Institute</button>';
//end of one button
