...
$urlparams = $_GET;
$PAGE->set_url('/local/jra/admin/university/major.php', $urlparams);
...
$PAGE->navbar->add(jra_get_string(['major']), new moodle_url('major.php'));

//Any form processing code
if(isset($_POST['delete_id'])) //only allow site admin to delete
{
	jra_query_delete_cascade('si_major', $_POST['delete_id']);
}

echo $OUTPUT->header();

//content code starts here
jra_ui_page_title(get_string('major','local_jra'));
$currenttab = 'major'; //change this according to tab
include('tabs.php');
